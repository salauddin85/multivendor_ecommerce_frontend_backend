...
export default function CancelList({ orders, paginationData }: CancelListProps) {
  ...
  if (orders.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2">No Cancelled Orders</h3>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-gray-500">
          Total {paginationData.count} cancellations
        </span>
      </div>
