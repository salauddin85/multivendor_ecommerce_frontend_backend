...
const navItems = [
  { href: "/dashboard/company/", label: "Home", icon: Home },
  {
    icon: ShieldIcon,
    label: "Roles Management",
    href: "#",
    urls: ["/dashboard/company/roles/", "/dashboard/company/roles/profile"],
    children: [
      { href: "/dashboard/company/roles", label: "Roles" },
      { href: "/dashboard/company/roles/profile", label: "My Roles" },
    ],
  },
  {
  ...
  },
  {
    ...
    href: "#",
    urls: ["/dashboard/company/staff/"],
    children: [
      { href: "/dashboard/company/staff/", label: "Staff" },
      { href: "/dashboard/company/staff/add/", label: "Add Staff" },
  ...
  
  {
    ...
    children: [
      ...
      {
        href: "/dashboard/company/products/variants/add/",
        label: "Add product variant",
        icon: ImageIcon,
      },
      {
        href: "/dashboard/company/products/attributes/add/",
      ...
      {
        href: "/dashboard/company/products/variants/",
        label: "View product variants",
        icon: ImageIcon,
      },
      {
        href: "/dashboard/company/products/attributes/",
  ...
  },
  {
    ...
    icon: BookMarked,
    children: [{ href: "/dashboard/company/orders/", label: "Orders" }],
  },
  {
    href: "#",
    label: "Wallets Management",
    icon: BookMarked,
    children: [{ href: "/dashboard/company/wallets/", label: "Wallets" }],
  },
  {
    href: "#",
    label: "Analytics",
    icon: BookMarked,
    children: [{ href: "/dashboard/company/analytics/", label: "Analytics" }],
  },
  // activity log
  {
    href: "#",
    ...
    icon: Logs,
    children: [{ href: "/dashboard/company/activity_logs/", label: "Activity Logs" }],
  },
];
export default function CompanyDashboardLayoutClient({
  children,
  permissions,
}: {
  ...
  return (
    <div className="flex h-screen w-screen bg-linear-to-b from-orange-50 to-white overflow-hidden">
      ...
      >
        ...
        >
          {!collapsed && (
            <h1 className="text-white font-bold text-lg">Company Dashboard</h1>
          )}
          <button
