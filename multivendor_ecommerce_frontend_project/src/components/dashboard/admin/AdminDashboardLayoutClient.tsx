...
const navItems = [
  { href: "/dashboard/admin/", label: "Home", icon: Home },
  {
    ...
    href: "#",
    urls: ["/dashboard/admin/roles/", "/dashboard/admin/roles/profile"],
    children: [
      { href: "/dashboard/admin/roles", label: "Roles" },
      { href: "/dashboard/admin/roles/profile", label: "My Roles" },
    ],
  },
  {
    icon: UserPlus,
    label: "Onboarding",
    href: "/dashboard/admin/registration/email",
    urls: ["/dashboard/admin/registration/"],
  },
  {
    icon: Activity,
    ...
    urls: [
      ...
      "/dashboard/admin/activity/my_log",
    ],
    children: [
      { href: "/dashboard/admin/activity/logs", label: "All Activity Log" },
      { href: "/dashboard/admin/activity/my_log", label: "My Activity Log" },
    ],
  },
  {
    icon: ShoppingCart,
    ...
    href: "#",
    urls: ["/dashboard/admin/sales/orders", "/dashboard/admin/sales/payments"],
    children: [
      {
      ...
      {
        href: "/dashboard/admin/sales/payments",
        label: "All Payments",
        icon: CreditCard,
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        href: "/dashboard/admin/products/variants/add/",
        label: "Add product variant",
        icon: ImageIcon,
      },
      {
        href: "/dashboard/admin/products/attributes/add/",
      ...
      {
        href: "/dashboard/admin/products/variants/",
      ...
      {
        href: "/dashboard/admin/products/reviews",
  ...
  // catalog management
  {
    ...
    children: [
      {
        href: "/dashboard/admin/catalogs/categories",
        label: "Categories",
        icon: FolderTree,
      },
      { href: "/dashboard/admin/catalogs/brands", label: "Brands", icon: Tag },
      {
        href: "/dashboard/admin/catalogs/categories/add",
        label: "Add Category",
        icon: Tag,
      },
      {
        href: "/dashboard/admin/catalogs/brands/add",
        label: "Add Brand",
        icon: Package,
      },
      {
        href: "/dashboard/admin/catalogs/carousal_images",
        label: "Carousal Images",
        icon: ImageIcon,
      },
      {
        href: "/dashboard/admin/catalogs/category_grid_images",
        label: "Category Grid Images",
        icon: ImageIcon,
      },
    ],
  },
  ...
  //     "/dashboard/admin/vendors/requests",
  //     "/dashboard/admin/vendors/payments",
  //     "/dashboard/admin/vendors/performance",
  //     "/dashboard/admin/vendors/commission",
  //   ],
  //   children: [
  //     { href: "/dashboard/admin/vendors", label: "All Vendors", icon: Users },
  //     {
  ...
  //     },
  //     {
  //       href: "/dashboard/admin/vendors/payments",
  //       label: "Vendor Payments",
  //       icon: CreditCard,
  //     },
  //     {
  //       href: "/dashboard/admin/vendors/performance",
  //       label: "Vendor Performance",
  //       icon: TrendingUp,
  //     },
  //     {
  //       href: "/dashboard/admin/vendors/commission",
  ...
  //     "/dashboard/admin/companies/requests",
  //     "/dashboard/admin/companies/payments",
  //     "/dashboard/admin/companies/performance",
  //     "/dashboard/admin/companies/commission",
  //   ],
  //   children: [
  //     {
  ...
  //     },
  //     {
  //       href: "/dashboard/admin/companies/requests",
  //       label: "Company Requests",
  //       icon: FileText,
  //     },
  //     {
  //       href: "/dashboard/admin/companies/payments",
  //       label: "Company Payments",
  //       icon: CreditCard,
  //     },
  //     {
  //       href: "/dashboard/admin/companies/performance",
  //       label: "Company Performance",
  //       icon: TrendingUp,
  //     },
  //     {
  //       href: "/dashboard/admin/companies/commission",
  //       label: "Commission Settings",
  //       icon: Settings,
  //     },
  //   ],
  // },
  {
    ...
    urls: [
      ...
      "/dashboard/admin/customers/wishlists",
      "/dashboard/admin/customers/address",
      "/dashboard/admin/customers/commission",
    ],
    children: [
      {
      ...
      {
        href: "/dashboard/admin/customers/wishlists",
        label: "Customer Wishlists",
        icon: Star,
      },
      // {
      //   href: "/dashboard/admin/customers/address",
      //   label: "Address Book",
      //   icon: MapPin,
      // },
      // {
      //   href: "/dashboard/admin/customers/commission",
      //   label: "Commission Settings",
      //   icon: Settings,
      // },
    ],
  ...
  // Blog Management
  {
    ...
    children: [
      ...
      { href: "/dashboard/admin/blogs/tags", label: "Tags", icon: Tag },
      {
        href: "/dashboard/admin/blogs/post",
        label: "Create Blog",
        icon: Briefcase,
      },
    ],
  ...
  //     },
  //     {
  //       href: "/dashboard/admin/payments/gateways",
  //       label: "Payment Gateways",
  //       icon: Wallet,
  //     },
  //     {
  //       href: "/dashboard/admin/payments/refunds",
  //       label: "Refunds",
  //       icon: Truck,
  //     },
  //   ],
  ...
  // Shipping Address Management
  {
    ...
    children: [
      {
        href: "/dashboard/admin/shipping/addresses",
        label: "All Shipping Addresses",
        icon: MapPin,
      },
      {
        href: "/dashboard/admin/shipping/configuration",
  ...
  // coupons management
  {
    ...
    children: [
      ...
      {
        href: "/dashboard/admin/coupons/coupon_usages",
        label: "Coupon Usages",
        icon: Tag,
      },
    ],
...
export default function AdminDashboardLayoutClient({
  ...
  return (
    <div className="flex h-screen w-screen bg-linear-to-b from-orange-50 to-white overflow-hidden">
      ...
      <aside
        className={`fixed lg:relative pb-2 top-0 left-0 h-screen z-40 flex flex-col bg-linear-to-b from-orange-600 via-orange-500 to-orange-600 transition-all duration-300 overflow-hidden ${
          sidebarOpen
            ? collapsed
              ? "w-20"
              : "w-64"
        ...
        >
          {!collapsed ? (
            <div className="flex items-center gap-2 w-full hover:bg-orange-500/50 overflow-x-hidden px-1 py-3 rounded-lg transition-colors">
              <button className="w-10 h-10 cursor-pointer rounded-full bg-white/30 hover:bg-white hover:text-black text-white flex items-center justify-center transition-colors">
                <LogOut size={16} />
              </button>
              <div className="text-left">
                ...
                <p className="text-xs text-orange-200">{userData?.email}</p>
              </div>
            </div>
          ) : (
            <button className="w-8 h-8 cursor-pointer rounded-full bg-white/30 hover:bg-white/40 text-white flex items-center justify-center transition-colors">
              <LogOut size={16} />
            </button>
          )}
        </div>
