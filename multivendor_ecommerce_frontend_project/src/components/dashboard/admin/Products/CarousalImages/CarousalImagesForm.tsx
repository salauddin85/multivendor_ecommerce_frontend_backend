...
export default function CarousalImagesForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axiosInstance.post('/api/catalog/v1/carousel_images/', submitFormData, {
        headers: {
      ...
      // Show success toast
      toast.success(response.data.message || 'Carousel image added successfully!');
      ...
      setTimeout(() => {
        router.push('/dashboard/admin/catalogs/carousal_images/');
        router.refresh();
      }, 2000);
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Create a new carousel image by filling out the form below
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            {imagePreview ? (
              <div className="relative mb-4">
                <div className="relative aspect-video w-full max-w-md rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
              ...
              <div className="mb-4">
                <div className="relative aspect-video w-full max-w-md rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-center">
